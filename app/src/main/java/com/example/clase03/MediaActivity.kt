    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        play!!.setOnClickListener{
            ...
            try {
                ...
                mediaPlayer!!.prepare()
                mediaPlayer!!.start()
                Toast.makeText(this@MediaActivity, "Comienza reproduccion", Toast.LENGTH_SHORT).show()
            }catch (e: IOException){
        ...
        stop!!.setOnClickListener{
            if (mediaPlayer != null && mediaPlayer!!.isPlaying){
                mediaPlayer!!.stop()
                mediaPlayer = null
                Toast.makeText(this@MediaActivity, "Se detiene reproduccion", Toast.LENGTH_SHORT).show()
            }
        }
    }
}